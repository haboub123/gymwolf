  ...
  return (
    <>
      ...
      <div className="p-8 min-h-screen" style={{backgroundColor: '#1e293b'}}>
        <h1 className="text-4xl font-bold mb-8 text-center" style={{color: '#fbbf24'}}>
          Nos Entraîneurs
        </h1>
            ...
            {coachs.map((coach) => (
              ...
              >
                <div className="flex flex-col items-center mb-4">
                  ...
                  />
                  <h2 className="text-xl font-semibold text-white text-center">{coach.username}</h2>
                </div>
                
                <div className="space-y-2">
                  <p>
                    <span className="font-medium" style={{color: '#fbbf24'}}>Email:</span> 
                    <span className="text-gray-300 ml-2">{coach.email}</span>
                  </p>
                  <p>
                    <span className="font-medium" style={{color: '#fbbf24'}}>Spécialité:</span> 
                    <span className="text-gray-300 ml-2">{coach.specialite || "Non précisée"}</span>
                  </p>
                  {coach.age && (
                    <p>
                      <span className="font-medium" style={{color: '#fbbf24'}}>Âge:</span> 
